...
// Description: Platform service for tenant management, RBAC, and configuration
...
use crate::handlers::create_tenant_router;
...
pub fn create_router(config: PlatformConfig) -> Router {
    ...
    Router::new()
        ...
        .nest("/api/v1/platform", create_tenant_router(tenant_service.clone()))
