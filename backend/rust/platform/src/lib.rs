...
// Description: Platform service for tenant management, RBAC, and user management
...
use crate::handlers::create_user_router;
use crate::services::{TenantService, RbacService};
...
pub fn create_router(config: PlatformConfig) -> Router {
    ...
    Router::new()
        ...
        .nest("/api/v1/platform", create_user_router(rbac_service.clone()))
